                    ...
                    <div class="row align-items-center justify-content-center justify-content-lg-between">
                        <div class="col-lg-6 order-0 order-lg-2">
                            <div class="banner__img text-center text-xxl-end">
                                <img src="{{ asset("frontendFile/assets/img/banner/banner_img.png") }}" alt="">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <ul class="about__icons__wrap">
                                <li>
                                    ...
                                    <img class="light" src="{{ asset('frontendFile/assets/img/icons/xd_light.png') }}" alt="XD">
                                    <img class="dark" src="{{ asset('frontendFile/assets/img/icons/xd.png') }}" alt="XD">
                                </li>
                                <li>
                                    <img class="light" src="{{ asset('frontendFile/assets/img/icons/skeatch_light.png') }}" alt="Skeatch">
                                    <img class="dark" src="{{ asset('frontendFile/assets/img/icons/skeatch.png') }}" alt="Skeatch">
                                </li>
                                <li>
                                    <img class="light" src="{{ asset('frontendFile/assets/img/icons/illustrator_light.png') }}" alt="Illustrator">
                                    <img class="dark" src="{{ asset('frontendFile/assets/img/icons/illustrator.png') }}" alt="Illustrator">
                                </li>
                                <li>
                                    <img class="light" src="{{ asset('frontendFile/assets/img/icons/hotjar_light.png') }}" alt="Hotjar">
                                    <img class="dark" src="{{ asset('frontendFile/assets/img/icons/hotjar.png') }}" alt="Hotjar">
                                </li>
                                <li>
                                    <img class="light" src="{{ asset('frontendFile/assets/img/icons/invision_light.png') }}" alt="Invision">
                                    <img class="dark" src="{{ asset('frontendFile/assets/img/icons/invision.png') }}" alt="Invision">
                                </li>
                                <li>
                                    <img class="light" src="{{ asset('frontendFile/assets/img/icons/photoshop_light.png') }}" alt="Photoshop">
                                    <img class="dark" src="{{ asset('frontendFile/assets/img/icons/photoshop.png') }}" alt="Photoshop">
                                </li>
                                <li>
                                    <img class="light" src="{{ asset('frontendFile/assets/img/icons/figma_light.png') }}" alt="Figma">
                                    <img class="dark" src="{{ asset('frontendFile/assets/img/icons/figma.png') }}" alt="Figma">
                                </li>
                            </ul>
                        </div>
                        <div class="col-lg-6">
                            <div class="about__content">
                                ...
                                <div class="about__exp">
                                    <div class="about__exp__icon">
                                        <img src="{{ asset('frontendFile/assets/img/icons/about_icon.png') }}" alt="">
                                    </div>
